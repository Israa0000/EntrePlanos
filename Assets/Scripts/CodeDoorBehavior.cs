...
{
    [Tooltip("Posici�n absoluta para puerta abierta (X/Z usados). Y se sustituye por la Y inicial de la puerta.")]
    [SerializeField] Vector3 absoluteOpenPosition = new Vector3(-18.715f, 0f, 2.644f);

    [Tooltip("Posici�n absoluta para puerta cerrada (X/Z usados). Y se sustituye por la Y inicial de la puerta.")]
    [SerializeField] Vector3 absoluteClosedPosition = new Vector3(-18.06f, 0f, 1.834f);

    [Tooltip("Si true, interpola tambi�n la rotaci�n (a�ade openAngle a la rotaci�n inicial en Y).")]
